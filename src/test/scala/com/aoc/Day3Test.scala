    ...
    it("passes more test cases") {
      val testCases: Map[Seq[Wire], Int] =
        Map(
          ...
          Seq(
            Seq("R98", "U47", "R26", "D63", "R33", "U87", "L62", "D20", "R33", "U53", "R51"),
            Seq("U98", "R91", "D20", "R16", "D67", "R40", "U7", "R15", "U6", "R7")) -> 410
        )
      testCases foreach { case (q, a) => new Day3Part2(q).closestIntersection shouldBe a }
    }

    it("answer the question") {
      new Day3Part2(Seq(qWire1, qWire2)).closestIntersection shouldBe 9238
    }
  }
}
