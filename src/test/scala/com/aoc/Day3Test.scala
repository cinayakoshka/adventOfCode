...
class Day3Test extends AnyFunSuite with Matchers {
  ...
  test("finds shortest path to intersection") {
  ...
  val testCases: Map[Seq[Wire], Int] =
    Map(
      ...
      //(0, 62),(66,62),(66,117),(100,117),(100,46),(155,46),(155, -12),(238, -12)
      ) -> 159,
